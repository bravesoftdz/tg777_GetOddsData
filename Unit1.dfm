object Form1: TForm1
  Left = 0
  Top = 0
  Caption = #28120#37329#32593#30424#21475#36164#26009#21462#24471#31243#24335
  ClientHeight = 956
  ClientWidth = 1099
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    Align = alTop
    TabOrder = 2
    object lbledt_url: TLabeledEdit
      Left = 48
      Top = 15
      Width = 801
      Height = 21
    ...
    object grp1: TGroupBox
      ...
      Width = 361
      Height = 65
      Caption = #28120#37329#32593#30331#20837#24080'/'#23494
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Tahoma'
      ...
      ParentFont = False
      TabOrder = 2
      object lbledt_user: TLabeledEdit
        Left = 64
        Top = 24
        Width = 89
        Height = 21
      ...
      object lbledt_pwd: TLabeledEdit
        Left = 200
        Top = 24
        Width = 145
        Height = 21
    ...
    object grp2: TGroupBox
      ...
      object se_update_interval: TSpinEdit
        Left = 103
        Top = 24
        Width = 82
        Height = 22
    ...
    object grp3: TGroupBox
      ...
      Width = 274
      Height = 65
      Caption = #26356#26032#33539#22260
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Tahoma'
      ...
      object chk_allupdate: TCheckBox
        Left = 16
        Top = 26
        Width = 81
        Height = 17
        ...
        State = cbChecked
        TabOrder = 0
        OnClick = chk_allupdateClick
      end
      object se_update_begin: TSpinEdit
        Left = 103
        Top = 24
        Width = 57
        Height = 22
      ...
      object se_update_end: TSpinEdit
        Left = 183
        Top = 24
        Width = 57
        Height = 22
    ...
    object grp4: TGroupBox
      ...
      object cbb_line: TComboBox
        ...
        ItemIndex = 2
        TabOrder = 0
        Text = #21414#38376#24191#19996#32447#36335
        OnChange = cbb_lineChange
        Items.Strings = (
          #19978#28023#21271#20140#32447#36335
          #28023#21335#25104#37117#32447#36335
          #21414#38376#24191#19996#32447#36335)
      end
    end
  end
  object Panel3: TPanel
    ...
    object chrm1: TChromium
      ...
      Height = 507
      Align = alClient
      DefaultUrl = 'w1.tg777.net'
      TabOrder = 0
      OnLoadEnd = chrm1LoadEnd
      OnAddressChange = chrm1AddressChange
      ExplicitHeight = 408
    end
  end
  object tmr_autorun: TTimer
    OnTimer = tmr_autorunTimer
    Left = 608
    Top = 419
  end
  object myconn1: TMyConnection
    Database = 'tg777'
  ...
  object ml_games: TMyLoader
    ...
    OnPutData = ml_gamesPutData
    Left = 800
    Top = 427
  end
  object ml_odds: TMyLoader
    Connection = myconn1
    TableName = 'Odds'
    Columns = <
      item
    ...
    OnPutData = ml_oddsPutData
    Left = 864
    Top = 427
  end
  object qry_temp: TMyQuery
    Connection = myconn1
    Left = 928
    Top = 427
  end
